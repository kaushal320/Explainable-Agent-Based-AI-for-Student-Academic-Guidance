        ...
        <nav className="flex-1 flex flex-col gap-2">
          {navItems.map(item => (
            <div 
              ...
              className={`nav-item-scholar ${activeTab === item.id ? 'active' : ''}`}
            >
              <item.icon size={20} />
      ...
      <main className="main-content-scholar">
        ...
        <AnimatePresence mode="wait">
          ...
          >
                   ...
                   <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col gap-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <motion.button 
                          ...
                          className="flex items-center gap-4 p-4 rounded-[1.25rem] text-white transition-all border-none relative overflow-hidden group"
            ...
            {activeTab === 'chat' && (
              <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden min-h-[700px]">
                 <Chat user={user} />
              </div>
            )}
